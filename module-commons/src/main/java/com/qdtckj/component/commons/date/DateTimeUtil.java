package com.qdtckj.component.commons.date;
...
public class DateTimeUtil {
     ...
     * @param dateStr 日期
     * @param timeStr 时间
     * @param sdf DateFormat
     * @return string datetime
     */
    public static String dateFormatByFormat(String dateStr,String timeStr,DateFormat sdf){
    ...
    public static Date parseDate(String strDate) {
        ...
        try {
            ...
            Logger.error(TAG, "parse date error", e);
        }
        return returnDate;
